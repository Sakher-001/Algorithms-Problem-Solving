...
void EachSumOfCols(int arr[3][3] , int NewArr[3] , short Rows , short Cols){
    for (int i = 0; i < Rows; i++)
    {
        NewArr[i] = SumOfCols(arr , 3 , i) ;
    }
...
void PrintSumOfArray(int arr[3] , short length){
    ...
    {
        cout << " Sum Of Cols " << i + 1 << " = " <<  arr[i] << endl ;
    }
...
int main(){
    ...
    EachSumOfCols(MatrixArr ,NewArr , 3 , 3); 
    cout << endl << endl;
    PrintSumOfArray(NewArr , 3) ;
}
